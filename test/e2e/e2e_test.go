...
import (
	...
	"github.com/absmach/propeller/test/utils"
)

// namespace where the project is deployed in
const namespace = "propeller-k8s-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "propeller-k8s-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "propeller-k8s-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "propeller-k8s-operator-metrics-binding"
