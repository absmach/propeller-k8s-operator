...
func main() {
	...
	flag.DurationVar(&livelinessInterval, "liveliness-interval", 10*time.Second,
	...
	flag.StringVar(&mqttAddress, "mqtt-address", "tcp://0.tcp.in.ngrok.io:13092", "The address of the MQTT broker.")
